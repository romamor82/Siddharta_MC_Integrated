  ...
  for (G4int i=0; i<nTuple; i++) {
    if (tupleListROOT[i] != "") {
      ...
      if (SiddhartaSetup == 2 || SiddhartaSetup == 6) {
        ...
        ROOTntup[i]->Branch("TotalEnergyDepKLCZTBoost",&ntuData.TotalEnergyDepKLCZTBoost,"TotalEnergyDepKLCZTBoost/D");
        ROOTntup[i]->Branch("gammaKinEKLCZTBoost",&ntuData.gammaKinEKLCZTBoost,"gammaKinEKLCZTBoost/D");
            ROOTntup[i]->Branch("nHitCZTBoost", &ntuData.nHitCZTBoost, "nHitCZTBoost/I");
        ROOTntup[i]->Branch("TimeKLCZTBoost",ntuData.TimeKLCZTBoost,"TimeKLCZTBoost[nHitCZTBoost]/D");
        ROOTntup[i]->Branch("EnergyDepKLCZTBoost",ntuData.EnergyDepKLCZTBoost,"EnergyDepKLCZTBoost[nHitCZTBoost]/D");
        ROOTntup[i]->Branch("XYZKLCZTBoost",ntuData.XYZKLCZTBoost,"XYZKLCZTBoost[3][nHitCZTBoost]/D");
        ROOTntup[i]->Branch("pdgcodeKLCZTBoost",ntuData.pdgcodeKLCZTBoost,"pdgcodeKLCZTBoost[nHitCZTBoost]/I");
        ROOTntup[i]->Branch("kaonKinEKLCZTBoost",ntuData.kaonKinEKLCZTBoost,"kaonKinEKLCZTBoost[nHitCZTBoost]/D");
      }

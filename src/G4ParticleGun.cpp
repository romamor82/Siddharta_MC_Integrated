...
//
//
// $Id: G4ParticleGun.cc,v 1.3 2011/03/05 18:06:52 romero Exp $
// GEANT4 tag $Name:  $
//
...
void G4ParticleGun::SetParticleEnergy(G4double aKineticEnergy)
{
  ...
  particle_momentum = std::sqrt((mass + aKineticEnergy)*(mass + aKineticEnergy) - mass*mass); // A.R.
  ...
  /*if(particle_definition){
    ...
    //particle_momentum = 0.0; // Commented by A. Romero
  }
}

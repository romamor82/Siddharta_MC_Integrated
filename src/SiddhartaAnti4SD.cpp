...
SiddhartaAnti4SD::SiddhartaAnti4SD(G4String name) : G4VSensitiveDetector(name)
{
  G4String HCname;
  collectionName.insert(HCname="trackerCollectionAnti4");
}

SiddhartaAnti4SD::~SiddhartaAnti4SD() {}

void SiddhartaAnti4SD::Initialize(G4HCofThisEvent* HCE)
{
...
G4bool SiddhartaAnti4SD::ProcessHits(G4Step* aStep,G4TouchableHistory*)
{
...
void SiddhartaAnti4SD::EndOfEvent(G4HCofThisEvent*)
{
  SiddhartaAnalysisManager* analysis = SiddhartaAnalysisManager::getInstance();
